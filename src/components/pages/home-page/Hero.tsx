  ...
  return (
    <div className="h-fit lg:h-96 hero mt-8 md:mt-20 lg:mt-48 hero-content flex flex-col lg:flex-row justify-between items-start lg:items-center">
      <div className="w-full h-full flex flex-col items-start">
        <h1 className="text-5xl lg:text-7xl font-primary font-normal text-white">
          Welcome
        </h1>
        <p className="font-normal text-gray-300 pr-8">
          I'm Russ, a software developer from Edmonton, Alberta, Canada. <br />
          I enjoy building scalable and efficient software products.
        </p>
