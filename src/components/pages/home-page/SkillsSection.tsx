...
export default function SkillsSection() {
  ...
  return (
    <section className="h-fit w-full mt-8 md:mt-20 lg:mt-48">
      <h2 className="text-4xl text-center font-primary font-normal text-white">
        My Skills
      </h2>
      ...
      <article className="text-white mb-24">
        <h1 className="text-6xl font-primary pl-4 ">Frontend</h1>
        <div className="w-72 border-b ml-4 border-blue-600 mb-8" />

        <div className="text-center grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-12 place-items-center lg:gap-8 w-full">
          <div>
